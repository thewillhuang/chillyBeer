...
},{"./../../bower_components/jquery/dist/jquery.js":1}],39:[function(require,module,exports){
'use strict';
var expect = require('chai').expect;
var main = require('../../public/js/main');

describe('test for true for running an ajax call', function() {
  it('should also be true', function() {
    expect(main()).to.be.true;
  });
});

},{"../../public/js/main":38,"chai":2}]},{},[39]);
